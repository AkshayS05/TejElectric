...
<header id="site-header" class="site-header" role="banner">
    <div class="top-bar">
        <div class="container">
            <span class="contact-info">Call us: +1 416 816 9850 |</span>
            <span class="opening-hours">Opening Hours: Mon-Sat 8:00 AM - 7:00 PM</span>
        </div>
    </div>
    ...
    <div class="primary-menu">
        ...
        <!-- Main Navigation -->
        <nav class="main-navigation" id="main-navigation" role="navigation" aria-label="Primary Menu">
